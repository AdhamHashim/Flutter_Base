<!--
  AUTO-GENERATED FROM: .claude/skills/feature-prompt/SKILL.md
  DO NOT EDIT THIS FILE DIRECTLY — your changes will be overwritten on the next
  run of scripts/sync-cursor.sh. Edit the canonical SKILL.md instead.

  Usage in Cursor:
    1. Type @ in the chat input
    2. Pick this file (feature-prompt.md)
