---
name: extensions-and-helpers
description: Reference for core extensions (TextStyleEx, padding/margin extensions, .szH/.szW, .toSliver, .onClick, FormatString, ContextExtension, FormMixin, IndexedMap) and helpers (Validators, InputFormatters, Helpers, ImageHelper, LauncherHelper, CacheStorage). Read this BEFORE writing any custom utility logic — most things are already there.
---

# Extensions & Helpers — USE BEFORE WRITING CUSTOM LOGIC

> **Golden rule:** قبل ما تكتب أي logic جديد لـ utility — اقرأ هذا الملف. فيه احتمال كبير اللي محتاجه موجود كـ extension أو helper.
